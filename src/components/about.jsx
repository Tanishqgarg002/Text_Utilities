...
export default function About() {
    ...
    const [tagbtn,settag]=useState('Enable dark mode')
    // let mystyle=
    const modechange=()=>{
...
<button className='btn btn-primary my-2' onClick={modechange}>{tagbtn}</button>
    </div>
  )
}
